...
function CardPerson({ id, gender, name, profile_path }: Props) {
  return (
    <LinkPage mediaType="person" id={id.toString()} titleMedia={name}>
      <div className="max-w-[200px] h-full flex flex-col shadow-md hover:scale-110 transition-all duration-75 hover:shadow-lg rounded-sm overflow-hidden hover:rounded-2xl ">
