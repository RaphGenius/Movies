...
function DropDown({ show }: Props) {
  ...
  return (
    <div className="relative  h-full  group group   ">
      ...
      <ul
        className=" absolute  flex py-4 px-4 w-64 scale-0 group-hover:scale-100 transition origin-top-left rounded dark:bg-slate-100 dark:text-black bg-slate-800 text-white 
       flex-col gap-4  "
      >
